        ...
        <div class="col-lg-5 col-md-7">
            <div class="card shadow border-0">
                <div class="card-body px-lg-5 py-lg-5">
                    <div class="mb-4 text-sm text-dark text-center">
                        <h2 class="text-dark">{{  __tr('Forgot your password?') }}</h2>
                        <hr>
                    ...
                    <x-lw.form action="{{ route('auth.password.request') }}" class="lw-ajax-form" data-secured="true">
                        ...
                        <div class="flex items-center justify-end mt-4">
                                 <button  type="submit" class="btn btn-success btn-lg btn-block mt-2">{{ __tr('Email Password Reset Link') }}</button>
                        </div>
                    </x-lw.form>
                </div>
            </div>
